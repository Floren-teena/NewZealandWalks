...
namespace NewZWalks.API.Data
{
    public class NewZWalksDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //Seeding data for the Difficulties
            var difficulties = new List<Difficulty>()
            {

                new Difficulty()
                {
                    Id = Guid.Parse("9b461092-5513-4259-9d1c-0181e53ef306"),
                    Name = "Easy"
                },
                 new Difficulty()
                 {
                     Id = Guid.Parse("e3589d2a-5c98-47f7-92d4-975872ea5525"),
                     Name = "Medium"
                 },
                  new Difficulty()
                  {
                      Id = Guid.Parse("d3950517-0fce-4f0b-82c5-d6f0083e46c5"),
                      Name = "Hard"
                  }
            };
